...
- **Librerías y funciones**
  ...
  - Se usan funciones para crear y editar objetos.

  - Generalmente las funciones que necesitamos ya  han sido escritas por otros colaboradores en paquetes o librerías que debemos "llamar" cada vez que se vayan a usar.
